...
export const Sidebar = ({ onCollapseChange }: SidebarProps) => {
    ...
    return (
        <>
            ...
            <nav className="fixed inset-x-0 bottom-0 z-50 flex items-center justify-around border-t border-slate-200/80 bg-white/90 backdrop-blur-xl px-2 py-1 md:hidden safe-bottom">
                {navItems.map((item) => {
                ...
                <button
                    ...
                    className="flex flex-1 flex-col items-center gap-0.5 rounded-xl py-2 text-[11px] font-medium text-slate-400 transition-colors"
                >
            ...
            <motion.aside
                ...
                className="fixed left-0 top-0 z-50 hidden h-screen flex-col border-r border-white/20 bg-white/60 backdrop-blur-2xl backdrop-saturate-150 shadow-[1px_0_30px_rgba(0,0,0,0.04)] md:flex"
            >
                {/* Header */}
